...
class TestQuery:
    ...
    def test_successful_query(self, mock_client):
        ...
        # answer is prefixed with the AI-generated/untrusted-input marker
        # (see services/provenance.py) -- assert the underlying text survives.
        assert result["answer"].endswith("The answer is 42.")
        assert "[AI-GENERATED" in result["answer"]
        ...
        assert result["_provenance"]["ai_generated"] is True
...
class TestQueryStatus:
    ...
    def test_completed_query_returns_result(self, mock_client):
        ...
        assert status["result"]["answer"].endswith("The answer is 42.")
